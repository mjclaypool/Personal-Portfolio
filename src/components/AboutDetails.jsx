export default function AboutDetails( {content}) {
  return (
    <div id="details-window" className="absolute py-4 px-6 h-[90%] lg:h-auto lg:min-h-[65%] w-[85%] bg-p-glacier-blue bg-opacity-70 rounded-md overflow-auto overflow-x-hidden">
