  ...
  learning: {
    ...
    buttons: [
      ...
      },
      {
        ...
        title: 'Post Graduate Program in User Experience Design',
        description: 'Solidified UX design concepts through multiple hands-on exercises. Collaborated with four other designers to plan out a pet health-tracking mobile app and present our concept to other peers and mentors of the program.',
